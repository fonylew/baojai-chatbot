...
const PROMPT = ```
  ...
  Be active but soft and kind to ask the questions to complete the keys. Do not be too passive or just response the user's answers. You can reflect or paraphrase the client's story, but always ask the questions in every responses at the end.
  ...
  Start with this JSON: { "strength": ["Courage to get the Help You Need"], "feeling": [], "thought": [], "situation": [], "action_next": [], "result_expect": [], "keys_complete": false, "chat_response": "" }
